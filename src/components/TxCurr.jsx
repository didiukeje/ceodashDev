...
const TxCurr = () => {
  return (
    <div className="w-full w-[32vw] h-[230px] bg-white rounded-md shadow-md p-6 flex flex-col justify-start items-start space-y-2">
        <p className="text-xs text-gray-600">2nd 95 Primary Indicator</p>
        <h2 className="text-lg font-semibold text-gray-800">TxCurr</h2>

        <p className="text-xs font-semibold text-gray-800">MONTHLY TX_CURR TREND</p>
